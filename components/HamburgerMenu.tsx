...
const HamburgerMenu = () => {
    ...
    return (
        <div ref={ref} className="relative">
            ...
            >
                <span
                    className={`h-0.5 w-6 bg-white transition ${toggled ? "translate-y-2 rotate-45" : ""
                        }`}
                />
                <span
                    className={`h-0.5 w-6 bg-white transition ${toggled ? "opacity-0" : ""
                        }`}
                />
                <span
                    className={`h-0.5 w-6 bg-white transition ${toggled ? "-translate-y-1 -rotate-45" : ""
                        }`}
                />
            </button>
